...
- **[style-discovery](./style-discovery/SKILL.md)** — Discover candidate writing-style rules empirically from paired drafts and final texts using keyness, effect size, pair dispersion, syntax, and concordances.
